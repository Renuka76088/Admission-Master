...
const sidebarLinks = [
  ...
  { name: "My Counselling", href: "/user/counselling", icon: CalendarDays },
  { name: "Career Intelligence", href: "/user/career", icon: Lightbulb },
  { name: "Exams", href: "/user/exams", icon: BookOpen },
  { name: "Colleges", href: "/user/colleges", icon: Building2 },
  { name: "Scholarships", href: "/user/scholarships", icon: Award },
  { name: "Paid Courses", href: "/user/courses", icon: CreditCard },
  { name: "Packages", href: "/user/packages", icon: Package },
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-inter">
      ...
      `}>
        ...
        <div className={`p-4 border-b border-slate-100 flex items-center sticky top-0 bg-white z-10 ${isCollapsed ? 'justify-center' : 'justify-end'}`}>
          {/* Mobile Close Button */}
          {!isCollapsed && (
            <button 
              onClick={() => setIsMobileOpen(false)} 
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            <Link href="/user/notifications" className="relative p-2 text-slate-600 hover:bg-slate-50 rounded-full transition-colors">
