...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-white grid-bg flex flex-col md:flex-row font-inter">
      {/* Mobile Overlay */}
      {isMobileOpen && (
        <div 
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto hidden-scrollbar flex flex-col">
          <div className="px-4 py-4">
            {!isCollapsed && <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Admin Menu</p>}
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            <button className="relative p-2 text-slate-600 hover:bg-white grid-bg rounded-full transition-colors">
